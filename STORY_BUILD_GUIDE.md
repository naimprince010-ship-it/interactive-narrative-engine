...
## দ্রুত স্টোরি যোগ করতে

1. **টেমপ্লেট:** `supabase/ADD_STORY_TEMPLATE.sql` — কপি করে আপনার গল্প দিয়ে জায়গা পূরণ করুন, তারপর Supabase SQL Editor এ Run করুন।
2. **উদাহরণ (রোমান্স):** `supabase/add_story_romance_example.sql` — "ক্যাফের সেই বিকেল" গল্প। পুরো ফাইল কপি করে Run করলেই সাইটে নতুন স্টোরি চলে আসবে।
